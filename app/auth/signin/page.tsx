        ...
        <div className="card">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex justify-center items-center px-4 py-3 border border-white/20 rounded-lg text-white hover:bg-white/10 transition-colors"
            >
